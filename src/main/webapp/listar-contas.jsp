...
<%@ page import="br.com.matheuscarino.fiapfintech.model.Conta" %>
...
<body>
    ...
    <div class="container">
        ...
        <%
            } else if (contas == null || contas.isEmpty()) {
        %>
                            ...
                            <tr>
                                ...
                                <td class="text-center">
                                    <c:url value="contas" var="link">
                                        ...
                                        <c:param name="id" value="${conta.id}"/>
                                    </c:url>
                                ...
                                <td class="text-center">
                                    <button type="button" class="btn btn-danger" data-bs-toggle="modal" data-bs-target="#excluirModal" onclick="setIdExcluir('${conta.id}')">
