...
- **Model**: Classes de modelo no pacote `br.com.matheuscarino.fiapfintech.model`
- **View**: Arquivos JSP na pasta `webapp`
- **Controller**: Servlets no pacote `br.com.matheuscarino.fiapfintech.controller`

Além disso, utiliza:

- **DAO**: Classes de acesso a dados no pacote `br.com.matheuscarino.fiapfintech.dao`
- **Filter**: Filtros para autenticação e autorização no pacote `br.com.matheuscarino.fiapfintech.filter`
- **Factory**: Fábricas para criação de objetos no pacote `br.com.matheuscarino.fiapfintech.factory`
- **Exception**: Classes de exceção personalizadas no pacote `br.com.matheuscarino.fiapfintech.exception`
...
- GitHub: https://github.com/matheuscarino
